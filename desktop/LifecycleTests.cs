    ...
    internal static class LifecycleTests
    {
        ...
        private static void RunStartupIntegration(string browserFolder)
        {
            ...
            File.WriteAllText(Path.Combine(fixture,"server.py"),
                ...
                "  body=(json.dumps(dict(app='yingxu',ok=True,version='0.4.19',instance_id=instance_id(default_data_root()))) if health else '<!doctype html><meta charset=utf-8><p id=fixture>YingXu startup fixture</p>').encode()\n"+
