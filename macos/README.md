...
完整解压 `YingXu-v0.4.4-mac.1-macOS-arm64.zip`，将 `YingXu.app` 拖入“应用程序”，双击打开。
...
- 同步 0.4.4 的 Markdown 项目文件链接、画板切换与撤销、本地字体、隐藏刷新和重复序列化修复；设置提供版本与缓存/历史占用预览。
...
再用 `python -B macos/verify_release.py releases/macos-preview/YingXu-v0.4.4-mac.1-macOS-arm64.zip`
